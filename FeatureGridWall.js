      ...
      <Fragment>
        ...
        {this.state.showWHWNoInventoryBanner &&
          ...
          <Modal
                ...
                >
                <ModalTitle primitive="h2">{"New Youtube TV subscribers save $10/mo for 12 months."}</ModalTitle>
                  <ModalBody>Offer available to Verizon Home Internet customers who are not a current or prior YouTube TV subscriber or trial user previously. Must activate YouTube TV subscription through YouTube TV w/in 90 days of new home internet activation/installation or when added to an existing internet plan. $10/month discount for 12 months on the standard subscription price, currently $72.99/mo. (subject to change); discount ends if home internet service is canceled (subscription will continue to be billed at the standard subscription price unless you cancel with YouTube TV). At the end of 12-month period you will be automatically charged the then-current standard subscription price. Must be 18 years or older. Valid form of payment required. Redeemable where YouTube TV is available. Full terms <a href="www.youtube.com/t/terms_paidservice" target="_blank">here:www.youtube.com/t/terms_paidservice</a>.</ModalBody>
                <Button className="u-text14 u-marginRightLarge" onClick={()=>{this.handleshowModal(false)}}>
              Got it
              </Button>
                </Modal>
      </Fragment>
