...
class FeatureTile extends Component
{
  ...
  componentDidUpdate(prevProps)
  {
    ...
    render() {
      const { legacyFeatureList,feature, isRecommendation, isExtenderForWHW,appleMutualIds:{mutualIds=[],getLabel=""},featuresCache,selMTN} = this.props;
        ...
        <Fragment>
          <div className="Feature-Tile" featureid={feature.sorId}>
            ...
            <div className='grid-top'>
              ...
              {/* Feature image. */}
              {showBanner && <div className="banner-text">New YouTube TV Subscribers save $120 first year. <span onClick={()=>this.props.handleshowModal(true)}>Details</span></div>}
